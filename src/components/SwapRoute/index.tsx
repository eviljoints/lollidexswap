...
const Route = ({
  ...
  }, [name, price, toToken, fromToken, setRoute, selected, index, gasUsd, amountUsd, airdrop, amountFrom, lossPercent, selectedChain]);
...
const RouteWrapper = styled.div<{ selected: boolean; best: boolean }>`
  ...
  &:hover {
    background-color: ${({ theme }) => (theme.mode === 'dark' ? '#161616;' : '#19a3b5;;')};
  }
`;
