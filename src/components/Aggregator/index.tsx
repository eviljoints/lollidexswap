...
const Body = styled.div<{ showRoutes: boolean }>`
  ...
  max-width: 30rem;
  box-shadow: ${({ theme }) =>
    theme.mode === 'dark' ? '10px 0px 50px 10px rgba(26, 26, 26, 0.9);' : '10px 0px 50px 10px rgba(211, 211, 211, 0.9);'};
  padding: 16px;
  border-radius: 16px;
  text-align: left;
...
const Routes = styled.div`
  ...
  box-shadow: ${({ theme }) =>
    theme.mode === 'light' ? '10px 0px 50px 10px rgba(26, 26, 26, 0.9);' : '10px 0px 50px 10px rgba(211, 211, 211, 0.9);'};
...
export function AggregatorContainer({ tokenlist }) {
  ...
  <Route
    ...
    fromToken={finalSelectedFromToken}
    // Remove this line if selectedChain is not needed
